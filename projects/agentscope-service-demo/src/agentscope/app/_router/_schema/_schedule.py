...
class CreateScheduleRequest(BaseModel):
    ...
    ended_at: datetime | None = Field(
        default=None,
        description="Optional final local date/time at which the schedule stops.",
    )

    project_id: str | None = Field(
        default=None,
        description="Optional project workspace to use for future runs.",
    )
...
class UpdateScheduleRequest(BaseModel):
    ...
    project_id: str | None = Field(
        default=None,
        description="Project workspace for future runs; null uses a private workspace.",
    )
