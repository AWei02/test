...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    async with AsyncExitStack() as stack:
        ...
        chat_service.audit_observer = getattr(app.state, "audit_observer", None)
        ...
        if knowledge_base_manager is not None:
            ...
            if enable_index_worker:
                ...
                worker = IndexWorker(
                    ...
                    document_parser=getattr(app.state, 'document_parser', None),
                    document_stage_processor=getattr(app.state, 'document_stage_processor', None),
                    resource_access_service=resource_access_service,
