...
class AsyncSQLAlchemyStorage(StorageBase):
    ...
    async def _delete_schedule_impl(
        ...
        """Delete a schedule and optionally retain its execution sessions."""
        from sqlalchemy import delete, select
    ...
    async def delete_schedule(
        ...
        *,
        ...
        """
        async with self._session() as sess:
            ok = await self._delete_schedule_impl(
                sess, user_id, schedule_id, preserve_sessions=preserve_sessions,
            )
            await sess.commit()
        return ok
