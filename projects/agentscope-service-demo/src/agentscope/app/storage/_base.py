...
class StorageBase(ABC):
    ...
    async def delete_schedule(
        ...
        *,
        ...
        When ``preserve_sessions`` is true, completed or running sessions
        previously created by the schedule remain available in the user's
        normal conversation history. Implementations must still remove the
        schedule's own indexes so it cannot run again.
