...
class ScheduleData(BaseModel):
    ...
    project_id: str | None = Field(
        default=None,
        description="Optional project whose workspace is used by future runs.",
    )

    workspace_version: int = Field(
        default=0,
        description="Bumped when a future schedule workspace changes.",
    )
