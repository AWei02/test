...
KnowledgeDocumentStatus = Literal[
    ...
    "indexing",
    "ready",
    "awaiting_parse_confirmation",
    "awaiting_chunk_confirmation",
    "error",
]
...
class KnowledgeDocumentData(BaseModel):
    ...
    access_mode: Literal["inherit", "private", "custom"] = Field(
        default="inherit",
        description="Document ACL mode. Inherit means every KB reader may read it.",
    )
    ...
    reuse_parsed_artifact: bool = False
    manual_stages: bool = False  # Legacy documents retain their original lifecycle.
    stage_action: Literal['parse', 'chunk', 'embed'] = 'parse'
    confirmed_parsing_version: str | None = None
    confirmed_chunks_version: str | None = None
    chunk_draft: dict[str, Any] = Field(default_factory=dict)
    chunking_config: dict[str, Any] | None = None
    indexed_chunking_config: dict[str, Any] | None = None
