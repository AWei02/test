...
import { UploadContext, type UploadContextValue } from './uploadContextState';
...
export function UploadProvider({ children }: UploadProviderProps) {
	...
	const enqueue = useCallback((knowledgeBaseId: string, files: File[], permissions?: UploadTask['permissions'], parsing?: UploadTask['parsing']): UploadTask[] => {
		const refs = refsRef.current!;
		const now = Date.now();
